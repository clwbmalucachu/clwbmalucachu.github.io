...
my $guestbookurl  = 'http://clwbmalucachu.co.uk/guest/guestbook.html`';
my $guestbookreal = '/www/clwbmalucachu/guest/guestbook.html';
my $guestlog      = '/www/clwbmalucachu/guest/guestlog.html';
my $cgiurl        = 'http://clwbmalucachu.co.uk/cgi-bin/guestbook.pl';
